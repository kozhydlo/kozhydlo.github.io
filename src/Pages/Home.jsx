...
const TechStack = memo(function TechStack({ tech }) {
	return (
...
const CTAButton = memo(function CTAButton({ href, text, icon: Icon }) {
	return (
		<a href={href}>
...
const TECH_STACK = ['React', 'Javascript', 'Node.js', 'Next js', 'C#', '.NET']
const SOCIAL_LINKS = [
