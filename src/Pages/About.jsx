				...
				<div className='flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center'>
					<div className='space-y-6 text-center lg:text-left'>
						...
						<p
							...
							data-aos-duration='1500'
						>
							Full Stack JS / Backend C# Developer | Specializing in React,
							Next.js, Node.js, C# and .NET. Passionate about clean code and
							building efficient solutions.
						</p>

						<div className='flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full'>
							<a
								href='https://drive.google.com/file/d/1vCA4e_vTUhPDIry8A8hqTq8aaZdIBEjz/view'
