...
function App() {
	...
	const review = [
		<Review
			...
			text='Професійний підхід і творчі ідеї - це ідеальна комбінація як повністю розкриває потенціал Марка. Наполегливість і креативність дають відмінний результат. Дуже задоволений виконанням роботи!
Завжди на зв’язку, оперативно реагує на зміни та чудово виконує поставлені завдання. Переходи на сайт стали зручними і привабливими для користувачів, дякую 🙏!!!'
		/>,
		<Review
			key={2}
			name='ZOMBIF'
